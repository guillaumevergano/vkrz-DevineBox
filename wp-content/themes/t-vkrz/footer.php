  ...
  <footer class="content-footer footer bg-footer-theme">
    <div class="container">
      <div class="container-fluid container-p-x pb-1">
        <div class="row mb-sm-3 mb-0 justify-content-center align-items-center">
          ...
          <div class="col-md-6">
            <div class="footer-container pb-1 text-center">
              <div class="share-menu">
                <ul class="share-links list-unstyled mb-4 list-inline">
                ...
                <ul class="share-links list-unstyled mt-2 list-inline">
                  <li class="list-inline-item">
