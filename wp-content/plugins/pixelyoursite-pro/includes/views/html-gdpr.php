            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="pys_list">
                        ...
                        <li><strong>CCPA rule:</strong> targets visitors from California, and uses Inform and opt-out
                            consent type.
                        </li>
            ...
            <div class="row justify-content-center">
                <div class="col-4">
                    <a href="https://www.pixelyoursite.com/plugins/consentmagic/?utm_source=pixelyoursite-pro&utm_medium=pixelyoursite-pro&utm_campaign=pixelyoursite-pro&utm_content=pixelyoursite-pro&utm_term=pixelyoursite-pro"
                       target="_blank" class="btn btn-sm pys_btn_orange">
...
<div class="card card-static">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                <p><a href="https://www.youtube.com/watch?v=uXTpgFu2V-E" target="_blank">The biggest problem with
                        consent messages (7:02 min) - watch now</a></p>
                <p><a href="https://www.youtube.com/watch?v=L_YYjrmxykU" target="_blank">Improve tracking under GDPR
                        consent with this smart option (5:31 min) - watch now</a></p>
                <p><a href="https://www.youtube.com/watch?v=ZOlNbIPS_Uc" target="_blank">Target your visitors with the
                        right consent rule (12:29 min) - watch now</a></p>
                <p><a href="https://www.youtube.com/watch?v=P8CLxslSPDk" target="_blank">The right to change your mind
                        (2:46 min) - watch now</a></p>
                <p><a href="https://www.youtube.com/watch?v=PsKdCkKNeLU" target="_blank">Facebook Conversion API and the
                        Consent Problem (9:25 min) - watch now</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                ...
                <p class="mb-0">Plugin: <a href="https://wordpress.org/plugins/cookiebot/" target="_blank">https://wordpress.org/plugins/cookiebot/</a>
                </p>
            </div>
        </div>
        <div class="row mt-3">
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_facebook_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-4">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_analytics_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
            <div class="col-4">
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_google_ads_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-4">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_pinterest_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-4">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_bing_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-4">
            ...
            <div class="col-4">
				<?php PYS()->render_text_input( 'gdpr_cookiebot_tiktok_consent_category', 'Enter consent category', !isCookiebotPluginActivated() ); ?>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                ...
                <p>Plugin: <a href="https://wordpress.org/plugins/cookie-law-info/" target="_blank">https://wordpress.org/plugins/cookie-law-info/</a>
                </p>
                <p class="mb-0">The options to track pixels before consent is captured won't work with this plugin
                    because it
        ...
        <div class="row">
            <div class="col">
                <p>Use following filters to control each pixel:
                    ...
                    <code>pys_disable_analytics_by_gdpr</code>, <code>pys_disable_tiktok_by_gdpr</code>, <code>pys_disable_google_ads_by_gdpr</code>,
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col">
                ...
                <p><code>pys_disable_landing_page_cookie</code> - disable pys_landing_page & last_pys_landing_page
                    cookies</p>
                <p><code>pys_disable_trafficsource_cookie</code> - disable pysTrafficSource & last_pysTrafficSource
                    cookies</p>
                <p><code>pys_disable_utmTerms_cookie</code> - disable ['utm_source', 'utm_medium', 'utm_campaign',
                    'utm_content' ,'utm_term'] with prefix <code>pys_</code> and <code>last_pys_</code> cookies</p>
                <p><code>pys_disable_utmId_cookie</code> - disable ['fbadid', 'gadid', 'padid', 'bingid'] with prefix
                    <code>pys_</code> and <code>last_pys_</code> cookies</p>
