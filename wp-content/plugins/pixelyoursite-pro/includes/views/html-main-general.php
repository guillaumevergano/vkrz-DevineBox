...
?>
    ...
    <div class="card card-static">
        ...
        <div class="card-body">
            ...
            <div class="row align-items-center mb-3 py-2">
                <div class="col-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/facebook-small-square.svg">
                </div>
                <div class="col-6">
            ...
            <div class="row align-items-center mb-3 py-2">
                <div class="col-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/analytics-square-small.svg">
                </div>
                <div class="col-6">
            ...
            <div class="row align-items-center mb-3 py-2">
                <div class="col-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/google-ads-square-small.svg">
                </div>
                <div class="col-6">
                    Your Google Ads Tag
                </div>
            ...
            <div class="row align-items-center mb-3 py-2">
                <div class="col-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/tiktok-logo.svg">
                </div>
                <div class="col-6">
                    Your TikTok
                </div>
    ...
    <div class="card card-static">
        ...
        <div class="card-body">
            <div class="row align-items-center mb-3 py-2">
                <div class="col-2">
                    <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/gtm-square-small.svg">
                </div>
                <div class="col-6">
                    Your GTM Tag
                </div>
