...
class EventRequest implements ArrayAccess {
  ...
  protected static $param_types = array(
    'events' => '\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Event[]',
   ...
   * @param PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Event[] $events An array of Server Event objects
   * @return $this
   */
   ...
   * @return PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Event[]
   */
