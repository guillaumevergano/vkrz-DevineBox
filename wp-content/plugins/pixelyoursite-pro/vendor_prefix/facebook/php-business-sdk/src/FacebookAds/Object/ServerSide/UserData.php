...
class UserData implements ArrayAccess {
  ...
  */
   ...
   * @param PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Gender $gender Gender, in lowercase. Either f or m.
   * @return $this
   */
   ...
   * <p>Example: array('f', 'm')
   * @param PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Gender[] $genders A list of Genders, in lowercase.
   * @return $this
   */
