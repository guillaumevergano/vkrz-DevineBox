 ...
 */
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(require("chart.js")) : "function" == typeof define && define.amd ? define(["chart.js"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).PYS_Chart)
}(this, (function(t) {
        "use strict";
        function e(t) {
            if (null === t || !0 === t || !1 === t)
        ...
        function a(t, a) {
            ...
            var i = n(t)
                , o = e(a);
            return isNaN(o) ? new Date(NaN) : o ? (i.setDate(i.getDate() + o),
                i) : i
        }
        function i(t, a) {
            r(2, arguments);
            ...
            var c = s.getDate();
            return u >= c ? s : (i.setFullYear(s.getFullYear(), s.getMonth(), u),
                i)
        }
        function o(t, a) {
            r(2, arguments);
        ...
        function C(t) {
            ...
            var e = n(t)
                , a = e.getMonth();
            return e.setFullYear(e.getFullYear(), a + 1, 0),
        ...
        function D(t, e) {
            r(2, arguments);
            var a, i = n(t), o = n(e), u = h(i, o), s = Math.abs(w(i, o));
            if (s < 1)
                a = 0;
            else {
        ...
        var P, q = {
            ...
            formatDistance: function(t, e, r) {
                var n;
                return r = r || {},
                    n = "string" == typeof x[t] ? x[t] : 1 === e ? x[t].one : x[t].other.replace("{{count}}", e),
        ...
        function L(t) {
            ...
            var e = n(t)
                , a = e.getUTCFullYear()
                , i = new Date(0);
            i.setUTCFullYear(a + 1, 0, 4),
                i.setUTCHours(0, 0, 0, 0);
            var o = W(i)
                , u = new Date(0);
            u.setUTCFullYear(a, 0, 4),
        ...
        function G(t, a) {
            ...
            var d = n(t)
                , l = d.getUTCDay()
                , f = (l < c ? 7 : 0) + l - c;
            return d.setUTCDate(d.getUTCDate() - f),
        ...
        function X(t, a) {
            ...
            var f = new Date(0);
            f.setUTCFullYear(o + 1, 0, l),
                f.setUTCHours(0, 0, 0, 0);
            var h = G(f, a)
                , m = new Date(0);
            m.setUTCFullYear(o, 0, l),
        ...
        var A = "midnight"
            ...
            b: function(t, e, r) {
                ...
                switch (n = 12 === a ? Z : 0 === a ? A : a / 12 >= 1 ? "pm" : "am",
                    e) {
                    case "b":
                    case "bb":
                        return r.dayPeriod(n, {
        ...
        var ot = {
            p: it,
            P: function(t, e) {
                var r, n = t.match(/(P+)(p+)?/), a = n[1], i = n[2];
                if (!i)
                    return at(t, e);
                switch (a) {
                    case "P":
        ...
        var ee = {
            ...
            Y: {
                ...
                set: function(t, e, r, n) {
                    ...
                    if (r.isTwoDigitYear) {
                        var i = _t(r.year, a);
                        return t.setUTCFullYear(i, 0, n.firstWeekContainsDate),
                            t.setUTCHours(0, 0, 0, 0),
                            G(t, n)
                    }
                    var o = "era"in e && 1 !== e.era ? 1 - r.year : r.year;
                    return t.setUTCFullYear(o, 0, n.firstWeekContainsDate),
                        t.setUTCHours(0, 0, 0, 0),
                        G(t, n)
                },
                ...
                set: function(t, a, i, o) {
                    return G(function(t, a, i) {
                        ...
                        var o = n(t)
                            , u = e(a)
                            , s = z(o, i) - u;
                        return o.setUTCDate(o.getUTCDate() - 7 * s),
                            o
                    }(t, i, o), o)
                },
                incompatibleTokens: ["y", "R", "u", "q", "Q", "M", "L", "I", "d", "D", "i", "t", "T"]
                ...
                set: function(t, a, i, o) {
                    return W(function(t, a) {
                        ...
                        var i = n(t)
                            , o = e(a)
                            , u = I(i) - o;
                        return i.setUTCDate(i.getUTCDate() - 7 * u),
                            i
                    }(t, i, o), o)
                },
            ...
            E: {
                ...
                set: function(t, e, r, n) {
                    return (t = Tt(t, r, n)).setUTCHours(0, 0, 0, 0),
                        t
                },
            ...
            a: {
                ...
                set: function(t, e, r, n) {
                    return t.setUTCHours($t(r), 0, 0, 0),
                        t
                },
            ...
            h: {
                ...
                set: function(t, e, r, n) {
                    ...
                    return a && r < 12 ? t.setUTCHours(r + 12, 0, 0, 0) : a || 12 !== r ? t.setUTCHours(r, 0, 0, 0) : t.setUTCHours(0, 0, 0, 0),
                        t
                },
            ...
            K: {
                ...
                set: function(t, e, r, n) {
                    return t.getUTCHours() >= 12 && r < 12 ? t.setUTCHours(r + 12, 0, 0, 0) : t.setUTCHours(r, 0, 0, 0),
                        t
                },
        ...
        var le = 36e5
            ...
            , we = /^([+-])(\d{2})(?::?(\d{2}))?$/;
        function ge(t) {
            var e, r = {}, n = t.split(fe.dateTimeDelimiter);
            if (n.length > 2)
                return r;
            if (/:/.test(n[0]) ? (r.date = null,
                e = n[0]) : (r.date = n[0],
                e = n[1],
            fe.timeZoneDelimiter.test(r.date) && (r.date = t.split(fe.timeZoneDelimiter)[0],
                e = t.substr(r.date.length, t.length))),
                e) {
                var a = fe.timezone.exec(e);
                a ? (r.time = e.replace(a[1], ""),
                    r.timezone = a[1]) : r.time = e
            }
            return r
        }
        function ve(t, e) {
        ...
        function ye(t, e) {
            ...
            }(e, a) ? (c.setUTCFullYear(e, i, Math.max(a, o)),
                c) : new Date(NaN)
        }
        function be(t) {
        ...
        t._adapters._date.override({
            ...
            parse: function(t, a) {
                ...
                return "number" === i || t instanceof Date ? t = n(t) : "string" === i && (t = "string" == typeof a ? function(t, a, i, o) {
                    ...
                    for (y = 0; y < p.length; y++) {
                        ...
                        if (x) {
                            ...
                            if (Array.isArray(k)) {
                                ...
                                if (U)
                                    throw new RangeError("The format string mustn't contain `".concat(U.fullToken, "` and `").concat(M, "` at the same time"))
                    ...
                    if (isNaN(o) || !o)
                        return new Date(NaN);
                    var c, d = o.getTime(), l = 0;
                    if (u.time && (l = Te(u.time),
                    isNaN(l) || null === l))
                        return new Date(NaN);
                    if (!u.timezone) {
                        var f = new Date(d + l)
                            , h = new Date(0);
                        return h.setFullYear(f.getUTCFullYear(), f.getUTCMonth(), f.getUTCDate()),
                            h.setHours(f.getUTCHours(), f.getUTCMinutes(), f.getUTCSeconds(), f.getUTCMilliseconds()),
                            h
                    }
                    return c = Ce(u.timezone),
                ...
                return function(t, a, i) {
                    ...
                    var y = c(v)
                        ...
                        , p = o.match(mt).map((function(t) {
                            ...
                            var n = nt[r];
                            if (n)
                                return !u.useAdditionalWeekYearTokens && lt(e) && ft(e, a, t),
                ...
                switch (e) {
                    ...
                    case "year":
                        return function(t) {
                            ...
                            var e = n(t)
                                , a = new Date(0);
                            return a.setFullYear(e.getFullYear(), 0, 1),
                                a.setHours(0, 0, 0, 0),
                                a
                        }(t);
                    default:
